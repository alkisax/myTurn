...
public class HappyPathTests
{
  ...
  public async Task CompleteBusinessFlowFromSetupToHistory()
  {
    ...
    int service = await Id(await Send(HttpMethod.Post, "/services/", adminToken, new { locationId = location, name = "test_happypath_service_" + unique, description = "test", isGeneric = false, estimatedServiceMinutes = 5 }));
